...
const Login = () => {
  ...
  return (
    ...
    text-slate-500'>
        ...
        <p className='text-sm text-purple-700 my-4
        cursor-pointer'>Forgot Password?</p>

        <button className='bg-purple-700 w-full text-white py-2
        ...
        <span className='text-purple-700 cursor-pointer' onClick={()=> setState('Login')}> Login</span></p>}
