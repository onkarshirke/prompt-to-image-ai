...
const Description = () => {
  return (
    ...
    <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
        ...
        <div>
            <h2 className='text-3xl font-medium max-w-lg'>Introducing the AI-Powered Prompt to Image Generator</h2><br/>
            ...
            even concepts that doesnt exist can be visualized 
