...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      >
        <p>Robust Text-to-Image Generator Alternative</p>
        <img src={assets.star_icon} alt="" />
      </motion.div>

      <motion.h1 className='text-4xl max-w-[300px] sm:text-7xl 
      sm:max-w-[590px] mx-auto mt-10 text-center'>Turn Prompt to <span className='text-purple-700'
      initial={{opacity: 0}}
      animate={{ opacity: 1 }}
      ...
      >Unleash your creativity with AI-Turn your imagination into visual art in Seconds Just type and generate the Image
      </motion.p>
    ...
    className='mt-2 text-neutral-600'>Generated Images from ArtifyAI</motion.p>
